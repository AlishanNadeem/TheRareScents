...
export const siteConfig = {
  ...
  social: {
    ...
    facebook: "https://www.facebook.com/share/1Exjv8r6FH/?mibextid=wwXIfr",
  },
  categories: [
    {
      label: "For Him",
...
export function getCategoryConfig(value) {
  return siteConfig.categories.find((category) => category.value === value);
}
