        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-neutral-700">
              ...
              <p>
                Every bottle we curate is chosen for its character, not just its
                name. We work in small batches, testing each blend for depth,
                longevity, and how it evolves on skin, so what you smell in the
                bottle is exactly what lingers hours later.
              </p>
              <p>
